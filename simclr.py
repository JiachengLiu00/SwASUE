...
parser.add_argument('--config_exp',
                    help='Config file for the experiment',default='./configs/pretext/simclr_svhn.yml')
...
def main():
    ...
    # # print(images[0].clone().detach().cpu().numpy())
    #     a=images_augmented[0].clone().detach().cpu().numpy()
    #     # print(a,type(a))
