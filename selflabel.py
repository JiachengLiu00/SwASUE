...
parser.add_argument('--config_exp',
                    help='Config file for the experiment',default='./configs/selflabel/selflabel_svhn.yml')
...
def main():
    ...
    criterion.cuda(3)
    print(criterion)
    # print(colored(criterion.device),'red')
    ...
    print(optimizer)
    # print(colored(optimizer.Parameter.device,'red'))
    ...
    # print(colored(train_dataloader.device,'red'))
    ...
    # model = model.cuda(0)
    print(colored(next(model.parameters()).device,'red'))
