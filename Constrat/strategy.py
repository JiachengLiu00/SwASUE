...
class Strategy:
	...
	def training_local_only(self, label_idxs, finetune=False):
		...
		# train and update
		label_train = DataLoader(DatasetSplit(self.dataset_train, label_idxs), batch_size=self.args.local_bs,
		                         shuffle=True)
		...
		scheduler = torch.optim.lr_scheduler.MultiStepLR(optimizer, [int(finetune_ep * 3 / 4)],
